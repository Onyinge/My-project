...
import com.example.jaccl.navigation.ROUTE_VIEW_UPLOAD
...
fun AddProductsScreen(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Cereal Selling/Buying? *",
                fontSize = 20.sp,
                fontFamily = FontFamily.Serif,
                color = Color.Green,
                modifier = Modifier.padding(20.dp),
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Quantity Of The Cereal *",
                fontSize = 20.sp,
                fontFamily = FontFamily.Serif,
                color = Color.Green,
                modifier = Modifier.padding(20.dp),
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Price Of The Cereal *",
                fontSize = 20.sp,
                fontFamily = FontFamily.Serif,
                color = Color.Green,
                modifier = Modifier.padding(20.dp),
